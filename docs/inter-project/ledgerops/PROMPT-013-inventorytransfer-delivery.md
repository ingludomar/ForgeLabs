...
|---|---|---|
| 2026-03-27 | Emisión | PROMPT emitido a LedgerOps — entrega de InventoryTransfer (Add · Query) con docs de 6 roles |
| 2026-03-27 | Resolución | Docs aplicados al repo (v1.12.0) |
